...
export function renderPaymentSummary(){
  ...
  let totalPriceCentsBeforeTax = productPriceCents + shippingPriceCents;
  let TaxPriceCents = totalPriceCentsBeforeTax * 0.1;
  let totalPriceCents = totalPriceCentsBeforeTax + TaxPriceCents;
